...
setMessageText("The Square of " + i + " is " + (0, _lib.square)(i));
(0, _jquery.default)('#message').click(function () {
  i++;
  setMessageText("The Square of " + i + " is " + (0, _lib.square)(i));
});
},{"./lib":"lib.js","jquery":"node_modules/jquery/dist/jquery.js","./styles.scss":"styles.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
